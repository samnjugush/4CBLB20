###########################################################################
## Makefile generated for component 'Robot_calibration_Ipos'. 
## 
## Makefile     : Robot_calibration_Ipos.mk
## Generated on : Mon Jan 27 11:52:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Robot_calibration_Ipos.elf
...
PRODUCT_NAME              = Robot_calibration_Ipos
MAKEFILE                  = Robot_calibration_Ipos.mk
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/ghattum/OneDrive_-_TU_Eindhoven/robotArm/robotarm_student/camera
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Robot_calibration_Ipos.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/shared/svd/include -I$(START_DIR)/Robot_calibration_Ipos_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
DEFINES_STANDARD = -DMODEL=Robot_calibration_Ipos -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/Robot_calibration_Ipos_ert_rtw/Robot_calibration_Ipos.c $(START_DIR)/Robot_calibration_Ipos_ert_rtw/Robot_calibration_Ipos_data.c $(START_DIR)/Robot_calibration_Ipos_ert_rtw/rtGetInf.c $(START_DIR)/Robot_calibration_Ipos_ert_rtw/rtGetNaN.c $(START_DIR)/Robot_calibration_Ipos_ert_rtw/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/mem_mgr.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/Ipos360.c $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dleadlag.c $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dlowpass1.c $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dweakint.c $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_IposResetEnc.c $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Supervisor.c $(MATLAB_WORKSPACE)/C/Users/ghattum/OneDrive_-_TU_Eindhoven/robotArm/robotarm_student/tooling/calibration/getSystemClockTimeval_wrapper.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/src/MW_raspi_init.c $(MATLAB_WORKSPACE)/C/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c $(MATLAB_ROOT)/toolbox/target/codertarget/rtos/src/linuxinitialize.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c

MAIN_SRC = $(START_DIR)/Robot_calibration_Ipos_ert_rtw/ert_main.c
...
%.c.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/OneDrive_-_TU_Eindhoven/robotArm/robotarm_student/tooling/calibration/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/OneDrive_-_TU_Eindhoven/robotArm/robotarm_student/tooling/calibration/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/OneDrive_-_TU_Eindhoven/robotArm/robotarm_student/tooling/calibration/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_calibration_Ipos.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/Robot_calibration_Ipos.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robot_calibration_Ipos_data.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/Robot_calibration_Ipos_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.c.o : $(START_DIR)/Robot_calibration_Ipos_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
getSystemClockTimeval_wrapper.c.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/OneDrive_-_TU_Eindhoven/robotArm/robotarm_student/tooling/calibration/getSystemClockTimeval_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
