...
## Generated on : Fri Jan 24 10:06:06 2025
...
%.c.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/robotArm/robotarm_student/Simulink/Robot1_12/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/robotArm/robotarm_student/Simulink/Robot1_12/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/robotArm/robotarm_student/Simulink/Robot1_12/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ec_Ebox.c.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Ebox.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_EboxResetEnc.c.o : $(MATLAB_WORKSPACE)/C/Users/ghattum/RobotArm/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_EboxResetEnc.c
	$(CC) $(CFLAGS) -o "$@" "$<"
