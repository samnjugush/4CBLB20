/*
 * Callibration_check_Robot_Ipos_types.h
 *
...
#ifndef RTW_HEADER_Callibration_check_Robot_Ipos_types_h_
#define RTW_HEADER_Callibration_check_Robot_Ipos_types_h_
#include "rtwtypes.h"
...
#ifndef typedef_emxArray_real_T_Callibration__T
#define typedef_emxArray_real_T_Callibration__T

typedef struct emxArray_real_T emxArray_real_T_Callibration__T;

#endif                             /* typedef_emxArray_real_T_Callibration__T */
...
#ifndef typedef_emxArray_char_T_Callibration__T
#define typedef_emxArray_char_T_Callibration__T

typedef struct emxArray_char_T emxArray_char_T_Callibration__T;

#endif                             /* typedef_emxArray_char_T_Callibration__T */

/* Parameters (default storage) */
typedef struct P_Callibration_check_Robot_Ipos_T_
  P_Callibration_check_Robot_Ipos_T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_Callibration_check_Robot_Ipos_T
  RT_MODEL_Callibration_check_Robot_Ipos_T;

#endif                   /* RTW_HEADER_Callibration_check_Robot_Ipos_types_h_ */
